...
router.route('/').post(auth(), validate(postValidation.createPost), postController.createPost).get(postController.getPosts);
router.route('/likeOrDislike/:postId').patch(auth(), postController.likeOrDislikePost);
